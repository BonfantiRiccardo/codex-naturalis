...
public class VirtualView implements EventListener {
    ...
    public void playerChoosesToken (Player p, Token t) {
        ...
        } catch (AlreadyAssignedException | IncorrectUserActionException | WrongGamePhaseException | NoCardsException e) {
            actionNotPermittedMessaging(p, e.getMessage());
        }
    }    //THIS METHOD IS REMOTELY CALLED BY THE CLIENT
    ...
    public void playerChoosesObjective(Player p, ObjectiveCard c) {
        ...
        } catch (AlreadyAssignedException | WrongGamePhaseException | IncorrectUserActionException | NoCardsException e) {
            actionNotPermittedMessaging(p, e.getMessage());
        }
    }    //THIS METHOD IS REMOTELY CALLED BY THE CLIENT
    ...
    public void playerDrawsCardFromDeck(Player p, ResourceDeck d) {
        ...
        } catch (IncorrectUserActionException | WrongGamePhaseException | AlreadyAssignedException | NoCardsException e) {
            actionNotPermittedMessaging(p, e.getMessage());
        }
    }    //THIS METHOD IS REMOTELY CALLED BY THE CLIENT
