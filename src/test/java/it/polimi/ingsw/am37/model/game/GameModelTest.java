...
class GameModelTest {
     ...
     */
    @Test
    void preparationTest() throws NoCardsException, AlreadyAssignedException, IncorrectUserActionException {
        g.preparationPhase();
     ...
     */
    @Test
    void endgameTest() throws NoCardsException, AlreadyAssignedException, IncorrectUserActionException {
        g.preparationPhase();
        g.playingPhase();
    ...
    void getGameWinnerTest() throws NoCardsException, AlreadyAssignedException, IncorrectUserActionException {
        ...
        GameModel g = new GameModel(giocatori, controller);
